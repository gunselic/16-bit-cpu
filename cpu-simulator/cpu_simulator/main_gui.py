...
class CPUSimulatorGUI:
    ...
    def setup_execution_tab(self):
        ...
        reg_outer_frame = tk.LabelFrame(content_frame, text="Registers (32)", bg=self.frame_bg, fg=self.text_color, font=("Segoe UI", 11, "bold"))
...
"""
    ...
    def update_display(self):
        ...
        for name, lbl in self.reg_labels.items():
            ...
            color = "#800080" if val != 0 else "#333"
